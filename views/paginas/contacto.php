<main class="contenedor seccion" data-cy="pagina-contacto">
        <h1 data-cy="titulo-contacto">Contacto</h1>

        <?php 
            if($mensaje) {
                echo "<div class='alerta'> <p class='texto $color'>" . $mensaje . "</p> </div>";
            }
        ?>
        ...
        <h2 data-cy="subTitulo-contacto">Llene el Formulario de Contacto</h2>
        ...
        <form class="formulario" action="/contacto" method="POST">
            ...
            <fieldset>
                ...
                <select data-cy="select-accion" id="opciones" name="contacto[tipo]">
            ...
            <input type="submit" value="Enviar" class="boton-verde" data-cy="enlace-enviar">
        </form>
